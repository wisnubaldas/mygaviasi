@extends('layouts.app',['menuLayout' => false])
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="custom-form mt-4 pt-2" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter email address" required >
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" name="password" class="form-control" placeholder=" @error('password') is-invalid @enderror"" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> WisnuBaldas<i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </div>
                        </div>
                    </div>
