    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="navbar-navlist">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Facilities & Flow<i class="mdi mdi-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="nav-link" href="#">Track & Trace</a></li>
                        <li><a class="nav-link" href="#">Flow Domestic</a></li>
                        <li><a class="nav-link" href="#">FLOW INTERNATIONAL</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Product & Services <i class="mdi mdi-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="nav-link" href="#">Ramp Handling</a></li>
                        <li><a class="nav-link" href="#">Warehouse Handling</a></li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <ul class="list-inline mb-0 ps-lg-4 ms-2">
                ...
                <li class="list-inline-item">
                    <a href="/login" class="primary-link"><i class="mdi mdi-upload"></i></a>
                </li>
            </ul>
        </div>
        <!--end collapse-->
